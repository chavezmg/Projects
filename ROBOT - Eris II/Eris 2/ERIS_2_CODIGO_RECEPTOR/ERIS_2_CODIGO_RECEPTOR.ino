...
void trap(){
  ...
  while(true){
    ...
    leer_sensores_front();
    leer_sensores_back();
    if (distancia_frontal_derecho >= 60 && distancia_frontal_izquierdo >=60){
      forward = true;
      break;}
    else if (distancia_trasero_derecho >= 60 && distancia_trasero_izquierdo >=60){
      forward = false;
      break;}
    else{
...
void decision_front(){
  ...
  if (distancia_frontal_derecho >= 35 && distancia_frontal_izquierdo >= 35 && forward){
    if (distancia_frontal_derecho >= distancia_frontal_izquierdo*2){
      adelante_derecha_45();}
    else if (distancia_frontal_izquierdo >= distancia_frontal_derecho*2){
      adelante_izquierda_45();}
    if (distancia_frontal_derecho >= 80 && distancia_frontal_izquierdo >= 80 ){
      adelante();}
    if (distancia_frontal_derecho >= 80 && distancia_frontal_izquierdo > 50  && distancia_frontal_izquierdo < 80 ){
      adelante_derecha_45();}
    else if (distancia_frontal_izquierdo >= 80 && distancia_frontal_derecho > 50 && distancia_frontal_derecho < 80 ){
      adelante_izquierda_45();}
    if (distancia_frontal_derecho >= 80 && distancia_frontal_izquierdo > 35  && distancia_frontal_izquierdo < 50 ){
      adelante_derecha_90();}
    else if (distancia_frontal_izquierdo >= 80 && distancia_frontal_derecho > 35 && distancia_frontal_derecho < 50 ){
      adelante_izquierda_90();}
      
    if (distancia_frontal_derecho >= 35 && distancia_frontal_izquierdo >= 35  && distancia_frontal_derecho < 80 && distancia_frontal_izquierdo < 80){
      if(distancia_frontal_derecho >= distancia_frontal_izquierdo){
        adelante_derecha_90();}
      else if(distancia_frontal_izquierdo >= distancia_frontal_derecho){
        adelante_izquierda_90();}
    }
  }
  else{
  ...
  else if (distancia_frontal_derecho >= 35 && distancia_frontal_izquierdo >= 35 && distancia_frontal_derecho < 50 && distancia_frontal_izquierdo < 50 && forward){
    if (distancia_frontal_derecho >= distancia_frontal_izquierdo){
      freno();
      adelante_derecha_90();}
    else{
  ...
  else if (distancia_frontal_derecho >= 50 && distancia_frontal_izquierdo >= 50 && distancia_frontal_derecho < 80 && distancia_frontal_izquierdo < 80 && forward){
    if (distancia_frontal_derecho >= distancia_frontal_izquierdo){
      adelante_derecha_45();}
    else{
      adelante_izquierda_45();}
...
void decision_back(){
  ...
  else if (distancia_trasero_derecho >= 35 && distancia_trasero_izquierdo >= 35 && distancia_trasero_derecho < 50 && distancia_trasero_izquierdo < 50 && forward){
  ...
  else if (distancia_trasero_derecho >= 50 && distancia_trasero_izquierdo >= 50 && distancia_trasero_derecho < 80 && distancia_trasero_izquierdo < 80 && forward){
    if (distancia_trasero_derecho >= distancia_trasero_izquierdo){
      atras_derecha_45();}
    else{
      atras_izquierda_45();}
...
void rcf(){
  ...
  if(valor_recibido>=10 && valor_recibido <20)
    spd = map(valor_recibido, 10, 20, 0, 10);
    adelante(spd)
    }
  if(valor_recibido>20 && valor_recibido <=30)
    spd = map(valor_recibido, 21, 30, 0, 10);
    atras(spd);
    }
  if(valor_recibido>30 && valor_recibido <=40)
    spd = map(valor_recibido, 31, 40, 0, 10);
    adelante_derecha_90(spd);
    }
  if(valor_recibido>40 && valor_recibido <=50)
    spd = map(valor_recibido, 41, 50, 0, 10);
    adelante_izquierda_90(spd);
    }
  if(valor_recibido>50 && valor_recibido <=60)
    spd = map(valor_recibido, 51, 60, 0, 10);
    adelante_derecha_45(spd);
    }
  if(valor_recibido>60 && valor_recibido <=70)
    spd = map(valor_recibido, 61, 70, 0, 10);
    adelante_izquierda_45(spd);
    }
